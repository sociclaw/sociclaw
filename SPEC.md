...
- Gerar: `POST https://<image-api-domain>/api/v1?path=generate`
- Poll: `GET https://<image-api-domain>/api/v1/jobs/{job_id}`
...
- `SOCICLAW_PROVISION_UPSTREAM_URL` (opcional; endpoint upstream de provisionamento)
